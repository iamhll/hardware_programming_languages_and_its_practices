...
#. open Ubuntu (For the first time, it will install itself and ask you to create a default user account)
...
#. install basic python library
   ...
   if it is very slow, you can try changing apt source:
...
#. open VS code and connect it to WSL (it will automatically install "WSL" extension)
...
#. download *pj_example_c_model*, put it to Ubuntu and open it with VS code (in WSL mode)
