...
*  Function
   ...
   #. change the directory to session\ *CSTR_TAG* and automatically run *xkmsc* to process test vectors specified with parameter *CSTR_DIR_VECT* (vector directory) and *CSTR_INFO_VECT_ALL* (vector information)
