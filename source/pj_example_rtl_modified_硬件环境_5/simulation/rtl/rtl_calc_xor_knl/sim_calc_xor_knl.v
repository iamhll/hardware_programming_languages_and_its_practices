//------------------------------------------------------------------------------
  //
  //  Filename       : sim_calc_xor_knl.v
  //  Author         : Huang Leilei
  //  Status         : draft
  //  Created        : 2026-03-03
  //  Description    : [testbench] for [calc_xor_knl]
  //
//------------------------------------------------------------------------------
...
//--- LOCAL (VARIABLE) -----------------
  ...
  `define SIM_KNOB_CHK_CALC_XOR_KNL_DAT    'b1
  `ifdef  SIM_KNOB_DBG
...
//--- LOCAL (CONSTANT) -----------------
  ...
  `define SIM_CSTR_FILE_CHKI_CALC_XOR_KNL_DAT_A    "check_data/CALC_XOR_dumpDatInp0_S1I16F0.dat"
  `define SIM_CSTR_FILE_CHKI_CALC_XOR_KNL_DAT_B    "check_data/CALC_XOR_dumpDatInp1_S1I16F0.dat"

  `define SIM_CSTR_FILE_CHKI_XXX    "XXX"

  `define SIM_CSTR_FILE_CHKO_CALC_XOR_KNL_DAT    "check_data/CALC_XOR_dumpDatOut_S1I16F0.dat"
