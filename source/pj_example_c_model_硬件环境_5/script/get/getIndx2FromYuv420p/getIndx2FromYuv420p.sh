...
#-------------------------------------------------------------------------------
    #
    #  Filename       : getIndx2FromYuv420p.sh
    #  Author         : Huang Leilei
    #  Status         : draft
    #  Created        : getBdRate
    #  Description    : generate index2 files from yuv420p files
    #
#-------------------------------------------------------------------------------

#*** PARAMETER *****************************************************************
CSTR_DIR_INP=${CSTR_DIR_INP:-"../../../data/HM"}      #REVERT_THIS_ITEM_BEFORE_YOU_COMMIT
CSTR_DIR_OUT=${CSTR_DIR_OUT:-"${CSTR_DIR_INP}_INDX2"}            #REVERT_THIS_ITEM_BEFORE_YOU_COMMIT
...
do
    ...
    ./getIndx2FromYuv444pCore.py tmp.yuv $NUMB_FRAME $SIZE_FRAME_X $SIZE_FRAME_Y $CSTR_FILE_OUT.yuv
