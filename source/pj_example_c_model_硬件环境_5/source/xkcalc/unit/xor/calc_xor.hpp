//------------------------------------------------------------------------------
    //
    //  Filename       : calc_xor.hpp
    //  Author         : Huang Leilei
    //  Status         : draft
    //  Created        : 2026-03-03
    //  Description    : xor related headers
    //
//------------------------------------------------------------------------------

#ifndef __CALC_XOR_HPP__
#define __CALC_XOR_HPP__
...
//*** CLASS ********************************************************************
// CALC_XOR
class CALC_XOR: public CALC_UNIT
{
//--- PRIVATE ENUMERATOR ---------------
private:
