...
============ ================== ====== =========== ======== =============== =============== =========== =============== =========================================================================================
 ...
 substractor  subFlgProc         1      /           bool     /               /               /           1               enable flag for processing
 substractor  subFlgSaturation   1      /           bool     /               /               /           0               enable flag for saturation
 substractor  subEnmLoad         1      /           int      0               2               /           0               enumerator for load source (<value> 0: pipeline 1: file 2: random)
 substractor  subEnmDump         1      /           int      0               2               /           0               enumerator for data dump (<value> 0: none 1: inout 2: intermediate)
 ...
 xor          xorFlgProc         1      /           bool     /               /               /           1               enable flag for processing
 xor          xorEnmLoad         1      /           int      0               2               /           0               enumerator for load source (<value> 0: pipeline 1: file 2: random)
 xor          xorEnmDump         1      /           int      0               2               /           0               enumerator for data dump (<value> 0: none 1: inout 2: intermediate)
